...
echo "<script>console.log('yes')</script>";
        ...
        if($row['name']=="Subway"){
        echo "<li style='clear:both'><a href='order.html?name=".$row['name']."'>".$row['img']."<div><span>".$row['description']."</span></div></a></li>";
        }
        else{
        echo "<li><a href='order.html?name=".$row['name']."'>".$row['img']."<div><span>".$row['description']."</span></div></a></li>";
          }
         }
